    ...
    {
        {
            ...
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0000, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_SUPPORTS_ONLINE_OFFLINE,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0001, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_ONLINE,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0002, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_OFFLINE,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0003, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_IS_OFFLINE,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0004, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_IS_IO_CAPABLE,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0005, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_QUERY_FAILOVER_SET,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0006, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_QUERY_VOLUME_NUMBER,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0007, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_LOGICAL_TO_PHYSICAL,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0008, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_PHYSICAL_TO_LOGICAL,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0009, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_IS_PARTITION,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x000A, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_READ_PLEX,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x000B, METHOD_CODES.METHOD_OUT_DIRECT, FILE_ACCESS.FILE_READ_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_IS_CLUSTERED,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x000C, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_SET_GPT_ATTRIBUTES,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x000D, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_GET_GPT_ATTRIBUTES,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x000E, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_GET_BC_PROPERTIES,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x000F, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_ALLOCATE_BC_STREAM,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0010, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_FREE_BC_STREAM,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0011, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_IS_DYNAMIC,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0012, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_PREPARE_FOR_CRITICAL_IO,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0013, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_QUERY_ALLOCATION_HINT,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0014, METHOD_CODES.METHOD_OUT_DIRECT, FILE_ACCESS.FILE_READ_ACCESS)
        },
        {
        VOLUME_IOCTL_Enum.IOCTL_VOLUME_UPDATE_PROPERTIES,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0015, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_QUERY_MINIMUM_SHRINK_SIZE,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0016, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_PREPARE_FOR_SHRINK,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0017, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_IS_CSV,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0018, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_ANY_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_POST_ONLINE,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x0019, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
        {
            VOLUME_IOCTL_Enum.IOCTL_VOLUME_GET_CSVBLOCKCACHE_CALLBACK,
            WinIOCtlFunctions.CTL_CODE( DEVICE_TYPES.IOCTL_VOLUME_BASE, 0x001A, METHOD_CODES.METHOD_BUFFERED, FILE_ACCESS.FILE_READ_ACCESS | FILE_ACCESS.FILE_WRITE_ACCESS)
        },
    };
}
